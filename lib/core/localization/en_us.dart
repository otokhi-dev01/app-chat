...
'profile': 'Profile',
  ...
  'search_hint_description': 'Search for chats, contacts, and messages',
  'scan_qr': 'Scan QR',

  'recent_searches': 'Recent Searches',
  'recent_visited': 'Recently Visited',
  'recent_contacts': 'Recent Contacts',
  'view_profile': 'View Profile',
  'clear_all': 'Clear All',
  'clear': 'Clear',
  'clear_search_history_title': 'Clear Search History?',
  'clear_search_history_confirm': 'Are you sure you want to clear all your recent searches?',
  ...
  'no_chats_match': 'No chats match "@query"',
...
'devices': 'Devices',
'manage_devices':
'View and manage devices using your account',
...
'dark': 'Dark',
'dark_theme': 'Always use dark mode',
...
'add_short_bio': 'Add a short bio about yourself',
...
'messages_groups_calls': 'Messages, groups, and calls',
...
'All chats have been marked as read',
'open_archived_chats':
'Opening archived chats',
'open_chat_settings':
...
'made_with_care': 'Made with care',
  ...
  'manage_storage_downloads_data': 'Manage storage, downloads, and data usage',

  // Data and storage
  'keep_media': 'Keep Media',
  'three_days': '3 days',
  'one_week': '1 week',
  'one_month': '1 month',
  'forever': 'Forever',
  ...
  'Network usage statistics were reset',
  ...
  'Remove temporary photos, videos, and files',

  // 'keep_media': 'Keep Media',
  'keep_media_description':
  'Choose how long downloaded media is stored',

  'automatic_media_download':
  'Automatic Media Download',

  'using_mobile_data': 'Using Mobile Data',
  'mobile_data_download_description':
  'Automatically download media using mobile data',

  'connected_to_wifi': 'Connected to Wi-Fi',
  'wifi_download_description':
  'Automatically download media when connected to Wi-Fi',

  'while_roaming': 'While Roaming',
  'roaming_download_description':
  'Downloading while roaming may result in extra charges',

  'media': 'Media',

  'media_quality': 'Media Quality',
  'media_quality_description':
  'Choose the upload and download quality',

  'stream_videos': 'Stream Videos',
  'stream_videos_description':
  'Play videos without waiting for the full download',

  'save_to_gallery': 'Save to Gallery',
  'save_to_gallery_description':
  'Save new photos and videos to your gallery',

  'data_usage': 'Data Usage',

  'data_saver': 'Data Saver',
  'data_saver_description':
  'Use less mobile data for calls and media',

  'reset_network_usage': 'Reset Network Usage',
  'reset_network_usage_description':
  'Reset sent and received data statistics',
  ...
  '@size of temporary photos, videos, and files will be removed. Your chats and saved messages will remain safe.',
  ...
  'Terminate any session you do not recognize, then change your password to keep your account secure.',
  ...
  'try_again': 'Try Again',
  'devices_load_failed':
  'We could not load your devices. Please check your connection and try again.',
  ...
  'Your QR code was saved to Photos.',
  ...
  'Profile link was copied to the clipboard.',
  ...
  'A new profile photo was captured.',
  'gallery_profile_photo_selected':
  'A new profile photo was selected from your gallery.',
  ...
  'change_group_photo': 'Change group photo',
